...
const messages = {
  fr: {
    ...
    disconnectInfo: 'Vous serez automatiquement déconnecté dans 67 secondes.',
    thankYou: '✅ Merci ! Vous allez être déconnecté...',
  },
  de: {
    title: 'Ihre Frage wird angezeigt!',
    badge: '🎉 WIRD ANGEZEIGT',
    disconnectInfo: 'Sie werden in 67 Sekunden automatisch getrennt.',
      ...
      <body>
        <div className="page">
          <div className="card">
            ...
            <div className="timer" id="timer">67s</div>
